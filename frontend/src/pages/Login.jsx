    ...
    <div className="bg-[#dddbdb] w-screen h-screen flex items-center justify-center">
      <form className="w-[90%] md:w-175 h-130 bg-white shadow-xl rounded-2xl flex flex-col md:flex-row overflow-hidden" onSubmit={(e)=>e.preventDefault()}>
        ...
        <div className="w-full md:w-1/2 h-full flex flex-col items-center justify-center gap-3">
          ...
          <div className="w-[80%] h-10 border border-black rounder-[5px] flex items-center justify-center" onClick={googelLogin}>
            <img src={google} className="w-6.25" alt="" />
            <span className="text-[18px] text-gray-500">oogle</span>
          </div>
          <div className="text-[#6f6f6f]">Create new account
            <span className="underline underline-offset-1 text-black ml-1" onClick={() => navigate("/signup")}>SignUp</span>
          </div>
        </div>
